...
<aside class="sidebar">
  ...
  <div>
    <a href="/admin/dashboard" class="sidebar-logo">
      ...
      <img src="{{asset('/img/gtechficon.png')}}" alt="site logo" class="light-logo">
      <img src="{{asset('/img/gtechficon.png')}}" alt="site logo" class="dark-logo">
      <img src="{{asset('/img/gtechficon.png')}}" alt="site logo" class="logo-icon">
    </a>
  </div>
...
@if(in_array('130', $rulesArray))
      ...
      <li class="dropdown">
        <a href="javascript:void(0)">
         <iconify-icon icon="mdi:account-question-outline" class="menu-icon"></iconify-icon>
...
<li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="/admin/interview-not-given"><i class="ri-circle-fill circle-icon w-auto"></i> Interview Not Given</a>
          </li>
          <li>
...
@if(in_array('120', $rulesArray))
      ...
      <li>
        <a href="/admin/list-employer-enquiry">
          <iconify-icon icon="mdi:briefcase-outline" class="menu-icon"></iconify-icon>
...
document.getElementById('attendance').addEventListener('change', function() {
    ...
    if (attendance === 'Attended') {
        ...
        // Optionally clear the status selection
...
<script>
    const courseOptions = {
        ...
        "Bachelor's": ["BSc", "BCom", "BA", "BTech Civil","BTech Mech", "BCA","BBA","BBM","Bsc Digital Media"],
