        ...
        <div class="max-w-464-px mx-auto w-100">
            <div>
                <a href="index.html" class="mb-40 max-w-290-px">
                    ...
                    <img src="{{asset('/img/gtechficon.png')}}" alt="" style="width: 100px">
                </a>
            ...
            <form>
                <div class="icon-field mb-16">
                    ...
                    <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username" id="username">
                </div>
                <div class="position-relative mb-20">
                    <div class="icon-field">
                        ...
                        <input type="password" class="form-control h-56-px bg-neutral-50 radius-12" id="password" placeholder="Password">
                    </div>
<span class="toggle-password ri-eye-line cursor-pointer position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light" data-toggle="#password"></span>
                ...
                <button type="button" onclick="SignIn()" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32" id="signin-button">  <i id="signin-loader" class="fa fa-spinner fa-spin" style="display: none;"></i>  Sign In</button>
...
function SignIn() {
            ...
            var rememberStatus = ($("#remember").prop('checked')) ? 1 : 0;
            ...
            if (username == '') {
                ...
                $('#username').focus().css('border', '1px solid #CCC');
            }
