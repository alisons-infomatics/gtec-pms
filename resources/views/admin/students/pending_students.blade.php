...
@section('content')
  ...
  <h6 class="fw-semibold mb-0">Approval Pending Students</h6>

</div>
    
    <div class="card basic-data-table">
      <div class="card-header">
        <h5 class="card-title mb-0">Approval Pending Students
