...
<div id="loader">
  ...
  <h6 class="fw-semibold mb-0">Interview Not Given List</h6>
...
<div class="col-md-2 align-self-end">
    <a href="{{ route('students.export', array_merge(['type' => 'not_given'], request()->all())) }}" class="btn btn-primary">Export as Excel</a>
        ...
        <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
          ...
          <tbody>
            ...
            <!--<td><img style="width : 50px;" src="@if($u->photo!='') {{asset($u->photo)}} @else /img/usr.jpg @endif" alt=""></td>-->
              ...
              <td>{{$u->GetDept->department ?? $u->dept_text}} / <br> {{$u->GetCrs->course ?? ''}}</td>
              <td>{{$u->mobile_code}}{{$u->mobile}}<br><small>{{$u->mobile_code}}{{$u->alternate_mobile}}</small></td>
              <td>{{$u->email}}</td>
