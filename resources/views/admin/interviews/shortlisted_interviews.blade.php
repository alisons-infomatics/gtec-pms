...
<div id="loader">
  ...
  <h6 class="fw-semibold mb-0">Short Listed Interviews</h6>

</div>
    
    <div class="card basic-data-table">
      <div class="card-header">
        <!--<h5 class="card-title mb-0">Short Listed Interviews-->
        <!--</h5>-->
        ...
        <div class="modal-content p-3">
          ...
          <div class="d-flex justify-content-around">
             <div class="modal-body text-center">
                <a href="{{ route('interview.students.export',array_merge(['type' => 'pdf','status'=> 'Short Listed'], request()->all())) }}" class="btn btn-danger">Export as PDF</a>
                <a href="{{ route('interview.students.export', array_merge(['type' => 'excel','status'=> 'Short Listed'], request()->all())) }}" class="btn btn-success">Export as Excel</a>
              </div>
          </div>
        </div>
      </div>
